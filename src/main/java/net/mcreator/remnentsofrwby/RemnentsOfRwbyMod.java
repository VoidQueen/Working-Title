package net.mcreator.remnentsofrwby;
...
@Mod("remnents_of_rwby")
public class RemnentsOfRwbyMod {
	public static final Logger LOGGER = LogManager.getLogger(RemnentsOfRwbyMod.class);
	public static final String MODID = "remnents_of_rwby";

	public RemnentsOfRwbyMod() {
